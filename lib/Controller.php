...
class Controller
{
    ...
    private function _create()
    {
        ...
        try {
            ...
            $this->return_message(1, $e->getMessage());
            return;
        }
        ...
        if (!FormatV2::isValid($data, $isComment)) {
            $this->return_message(1, I18n::_('Invalid data.'));
            return;
        }
        ...
        if ($isComment) {
            ...
            if ($paste->exists()) {
                ...
                $this->return_message(0, $comment->getId());
            } else {
                $this->return_message(1, I18n::_('Invalid data.'));
            }
        }
        // The user posts a standard paste.
            ...
            try {
                ...
                return $this->return_message(1, $e->getMessage());
            }
            $this->return_message(0, $paste->getId(), array('deletetoken' => $paste->getDeleteToken()));
        }
    }
    ...
    private function _delete($dataid, $deletetoken)
    {
        ...
        if ($this->_request->isJsonApiCall()) {
            if (strlen($this->_error)) {
                $this->return_message(1, $this->_error);
            } else {
                $this->return_message(0, $dataid);
            }
        }
    }
    ...
    private function _read($dataid)
    {
        ...
        try {
            ...
            if ($paste->exists()) {
                ...
                $this->return_message(0, $dataid, (array) $data);
            } else {
                $this->return_message(1, self::GENERIC_ERROR);
            }
        } catch (Exception $e) {
            $this->return_message(1, $e->getMessage());
        }
     ...
     * @param  array $other
     */
    private function return_message($status, $message, $other = array())
    {
